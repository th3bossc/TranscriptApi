...
def extract_text_pdf(file_location = 'transcript_api/static/files/temp.pdf'):
...
def extract_text_txt(file_location = 'transcript_api/static/files/temp.txt'):
...
def summarize_file(file_location, file_extension, working_dir = "transcript_api/static/files"):
